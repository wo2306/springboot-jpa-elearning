...
<body>
    <div class="container" style="padding-left: 400px; padding-right: 400px;">
        <div class="columns is-centered question_header" style="height:70px;">
          <div class="column is-10">
            <h1 class="articel_title"> 제목 : 맥에서 cmd+i 를 눌렀는데 하단 콘솔바가 뜨지 않습니다</h1>
          </div>
        </div>
        <hr>
        <div class="columns is-centered question_body">
          <div class="column is-9">
            <div class="post_container" style="padding-top: 10px;">         
            <article class="media post" fxd-data='{"id":19113,"recommended_cnt":0,"type":"post"}'>
            <div class="media-left image is-32x32 is-rounded">
                <img class="is-rounded" src="https://cdn.inflearn.com/public/users/thumbnails/thumbnail_default.png" width="50px" alt="Sanghyeok KIM 프로필">
            </div>
                <div class="content">
                    <div class="media-content">
                        <div class="content">                 
                            <div class="author">
                            <span class="author"><strong>작성자 : Sanghyeok KIM</strong></span>
                            <span class="option" fxd-data="{&quot;id&quot;:19113,&quot;type&quot;:&quot;question&quot;}"> </span>
                            </div>
                            <div class="article_body"><p>내용 : 어떻게해야할까요.. 도저히 검색을 해도 안나오고 지웠다 깔아도 안되네요.. 이것때문에 너무 스트레스 받습니다 ㅠㅠ</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <hr>
            <div class="media-content" >
                <div class="field" style="height: 200px; border: 1px solid #808080;">
                    <body id="tinymce" class="mce-content-body " data-id="mce_0" contenteditable="true" spellcheck="false" style="overflow-y: hidden; padding-left: 1px; padding-right: 1px; padding-bottom: 50px; min-height: 0px;" data-mce-style="overflow-y: hidden; padding-left: 1px; padding-right: 1px; padding-bottom: 50px; min-height: 0px;">
                        <p>
                            <br data-mce-bogus="1">
                        </p>
                    </body>
                ...
                <button class="button submit_comment is-primary" disabled>로그인 시 답변을 제출할 수 있습니다.</button>
                <button>답변하기</button>
                </div>
            </div>
            </div>
