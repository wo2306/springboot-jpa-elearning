																						...
																						<div class="modal-body">
																							<div class="card-content">
																								<div class="total_amount_container">
																									...
																									<form
																										action="${pageContext.request.contextPath}/review/insert"
																										name="review">
																											...
																											<tbody>
																												...
																												<tr>
																													<td colspan="2"><textarea
																														...
																														<input type="hidden" name="onLecture.onLectureNo"
											...
											<table class="table table-hover">
												...
												<c:choose>
													<c:when test="${offOrderList ne null}">
														<c:forEach items="${requestScope.offOrderList}"
															var="offOrder">
															<tr>
																<td>${offOrder.offOrderNo}</td>
																<td>${offOrder.offLecture.offLectureName}</td>
																<td><fmt:formatDate
																		value="${offOrder.offOrderRegdate}"
																		pattern="yyyy.MM.dd" /></td>
																<td>${offOrder.offOrderMethod}</td>
																<td><fmt:formatNumber
																		value="${offOrder.offLecture.price}" pattern="₩#,###" /></td>
															</tr>
														</c:forEach>
													</c:when>
													<c:otherwise>
														<tr>
															<td colspan="7" style="text-align: center">주문 내역이
																존재하지 않습니다.</td>
														</tr>
													</c:otherwise>
												</c:choose>
													...
													<c:choose>
														<c:when test="${questionList!=null}">
															<c:forEach var="dto" items="${questionList}">
																<tr>
																	<th scope="row"><img
																		src="${pageContext.request.contextPath}/images/onLecture/${dto.onLecture.onLectureNo}.png"
															...
															<c:forEach var="dto" items="${reviewList}">
																<tr>
																	...
																	<td><c:forEach var="i" begin="1"
																			...
																			<span class="fa-hover"><i class="fa fa-star"></i>
																			</span>
																		</c:forEach></td>
																	<td>
																				...
																				<div class="modal-content">
																					...
																					<div class="modal-body">
																						<form
																							...
																							<table class="table table-hover">
																								<tbody>
																									...
																									<tr>
																										<td colspan="2"><textarea
																												name="reviewContent" cols="30" rows="13"
																												placeholder="${dto.reviewContent }"
																												name="reviewContent"></textarea> <input
																											type="hidden" name="reviewNo"
																											value="${dto.reviewNo }"></td>
																							...
																							<div class="modal-footer">
																								<button type="submit" id="reviewUpdate"
																									class="btn btn-primary text-white">수정
																								</button>
