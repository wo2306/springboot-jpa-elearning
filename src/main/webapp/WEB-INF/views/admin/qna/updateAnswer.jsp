            ...
            <div class="container">
                <div class="section-content">
                    <div class="row" id="out">
							...
							<form name = "classAnswer" id="booking-form" name="booking-form" action="${pageContext.request.contextPath}/admin/qna/answerUpdate/update"
								method="post">
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group">
											<label>답변 번호</label> <input type="text"
												value="${classAnswer.classAnswerNo }" readonly="true"
												class="form-control">
										</div>
									</div>
									<div class="col-sm-6" >
										<div class="form-group">
											<label>작성자</label> <input type="text"
												value="${classAnswer.userdb.userdbNickname }" readonly="true"
												class="form-control">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>관련 질문 번호</label> <input type="text"
												value="${classAnswer.classQuestion.classQuestionNo }" readonly="true"
												class="form-control">
										</div>
									</div>
									<script>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label>답변 내용</label> <input type="text"
												value="${classAnswer.classAnswerContent }"
												class="form-control">
										</div>
									</div>
