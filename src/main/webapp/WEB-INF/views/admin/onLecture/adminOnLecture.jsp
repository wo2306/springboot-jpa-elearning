...
<form name="updateForm" method="post"
							...
							<table class="table table-bordered" id="dataTable" width="100%"
								...
								<tr>
									<th>onLectureNo</th>
									<th>onLectureCategory</th>
									<th>onLectureTeacher</th>
									<th>onLecturePrice</th>
									<th>onLectureRegdate</th>
									<th>onLectureContent</th>
									<th>onLectureDiscount</th>
									<th>onLectureSummary</th>
									<th>수정</th>
									<th>삭제</th>
								</tr>
								<c:forEach items="${requestScope.list}" var="list">
									<tr>
										...
										<td>${list.onLecturePrice}</td>
										<td>${list.onLectureRegdate}</td>
										<td>${list.onLectureContent}</td>
										<td>${list.onLectureDiscount}</td>
										<td>${list.onLectureSummary}</td>
										<td><input type="button" value="수정" onClick="location.href='${pageContext.request.contextPath}/admin/user/updateForm/${list.onLectureNo}'"></td>
                              <td><input type="button" value="삭제" id=${list.onLectureNo}></td>
									</tr>
								</c:forEach>
							</table>
							</form>
