...
public class Vimeo {
    ...
    public VimeoResponse get(String endpoint) throws IOException, JSONException {
        return apiRequest(endpoint, HttpGet.METHOD_NAME, null, null);
    }

    public VimeoResponse get(String endpoint, Map<String, String> params) throws IOException, JSONException {
    ...
    public VimeoResponse put(String endpoint, Map<String, String> params) throws IOException, JSONException {
    ...
    public VimeoResponse delete(String endpoint, Map<String, String> params) throws IOException, JSONException {
    ...
    public VimeoResponse patch(String endpoint, Map<String, String> params) throws IOException, JSONException {
    ...
    public VimeoResponse addVideoPrivacyDomain(String videoEndpoint, String domain) throws ClientProtocolException, UnsupportedEncodingException, IOException, JSONException {
    ...
    public VimeoResponse uploadVideo(byte[] bytes, String uploadLinkSecure) throws IOException, JSONException {
        return uploadVideo(new ByteArrayInputStream(bytes), uploadLinkSecure);
    }

    public VimeoResponse uploadVideo(InputStream inputStream, String uploadLinkSecure) throws IOException, JSONException {
    ...
    public String addVideo(byte[] bytes, boolean upgradeTo1080) throws IOException, VimeoException, JSONException {
        return addVideo(new ByteArrayInputStream(bytes), upgradeTo1080);
    }

    public String addVideo(InputStream inputStream, boolean upgradeTo1080) throws IOException, VimeoException, JSONException {
        Map<String, String> params = new HashMap<String, String>();
        params.put("type", "streaming");
        params.put("redirect_url", "http://localhost:8888/vimeoCallback");
    ...
    public VimeoResponse likesVideo(String videoId) throws IOException, JSONException {
    ...
    public VimeoResponse checkEmbedPreset(String videoEndPoint, String presetId) throws IOException, JSONException {
    ...
    protected VimeoResponse apiRequest(String endpoint, String methodName, Map<String, String> params, InputStream inputStream) throws IOException, JSONException {
